  ...
  <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed">
        ...
        <Link to='/user' style={{ textDecoration: 'none' }}>
          ...
          <Button key="one" style={{background:'#f0f2f5',fontWeight:'bold',marginRight:'5px'}} startIcon={<UpdateIcon/>}><Link to='/user/upcoming-events' style={{ textDecoration: 'none', textTransform:'none' }}>Upcoming Events</Link></Button>
