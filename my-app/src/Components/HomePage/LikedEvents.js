...
export default function Feed() {
    ...
    return (
        <>
    <u style={{color:'#f74235'}} ><h2 className="text-center mb-4" >Liked Events</h2></u>
    <h6 className="text-center mb-4"  style={{color:'#1b7bd3', margin:-20}}>Your liked events history</h6>
